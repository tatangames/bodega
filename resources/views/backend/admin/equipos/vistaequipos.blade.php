        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Lista Equipos</li>
                </ol>
            </div>
        </div>
    </section>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Equipo</label>
                                        <input type="text" maxlength="100" class="form-control" id="equipo-nuevo" autocomplete="off">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Equipo</label>
                                        <input type="text" maxlength="100" class="form-control" id="equipo-editar" autocomplete="off">
                                    </div>
...
@section('archivos-js')
    ...
    <script>
            ...
            axios.post(url+'/equipos/informacion',{
                ...
                .then((response) => {
                    ...
                    if(response.data.success === 1){
                        ...
                        $('#id-editar').val(id);
                        $('#equipo-editar').val(response.data.equipo.nombre);
        ...
        function editar(){
            ...
            if(equipo.length > 100){
                toastr.error('Equipo máximo 100 caracteres');
                return;
            }
