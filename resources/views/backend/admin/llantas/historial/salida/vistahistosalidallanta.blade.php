        ...
        <div class="container-fluid">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Salidas Registradas para Llantas</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/historial/salida/llanta/tabla') }}";
    ...
    <script>
        ...
        function informacion(id){
            window.location.href="{{ url('/admin/historialdeta/salida/llanta/') }}/" + id;
        }
        ...
        function borrarRegistro(id){
            ...
            axios.post(url+'/historial/salida/llanta/borrar', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function infoEditar(id){
            ...
            axios.post(url+'/historial/salida/llanta/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/historial/salida/llanta/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
