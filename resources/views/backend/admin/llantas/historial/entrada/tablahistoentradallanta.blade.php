                            ...
                            @foreach($lista as $dato)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge bg-warning">Llanta de Inventario</span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @can('btn.historial.entrada.llanta.btn.editar')
                                            <br><br>
                                        ...
                                        @if($dato->documento != null)
                                            <br><br>
                                            <a class="btn btn-primary btn-xs" href="{{ url('/admin/entradas/historialllanta/documento/'.$dato->id) }}">
                                                <i class="fas fa-eye" title="Documento"></i> Ver Documento </a>

                                            @can('btn.historial.entrada.llanta.btn.borrardocumento')
                                                <br><br>
                                            ...
                                            @endcan
                                        @else
                                            @can('btn.historial.entrada.llanta.btn.agregardocumento')
                                                <br><br>
                                        ...
                                        @can('btn.historial.llanta.entrada.btn.borrarregistro')
                                            @if($dato->btnbloqueo)
                                                <br><br>
