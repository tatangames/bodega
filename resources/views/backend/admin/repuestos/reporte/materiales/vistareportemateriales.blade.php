                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-10">
                                            ...
                                            <div class="info-box shadow">
                                                <div class="info-box-content">
                                                    <label>Tipo</label>
                                                    <select class="form-control" id="select-tipo-individual" style="width: 25%">
                                            ...
                                            <div class="info-box-content" style="margin-top: 4px">
                                                ...
                                                <select id="select-materiales" class="form-control">
                                                    @foreach($arrayMateriales as $item)
                                            ...
                                            <div class="info-box shadow" style="margin-top: 35px">
                                                <div class="info-box-content">
...
@section('archivos-js')
    ...
    <script>
        ...
        function generarPdfEquipo(){
            ...
            var idmaterial = document.getElementById('select-materiales').value;
            ...
            if(tipo == '1'){
                window.open("{{ URL::to('admin/reporte/pdf/material/entradas') }}/" + desde + "/" + hasta + "/" + idmaterial);
            }else{
                window.open("{{ URL::to('admin/reporte/pdf/material/salidas') }}/" + desde + "/" + hasta + "/" + idmaterial);
            }
