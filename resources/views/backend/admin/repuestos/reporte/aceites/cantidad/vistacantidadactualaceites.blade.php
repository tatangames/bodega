            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="callout callout-info">
                        <h5><i class="fas fa-info"></i> Generar Reporte por Cantidades Actual de Aceites y Lubricantes</h5>
                        <div class="card">
...
@section('archivos-js')
    ...
    <script>
        ...
        function generarPdf() {
            window.open("{{ URL::to('admin/reporte/aceitelubricantes/cantidades') }}");
        }
