...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            let id = {{ $id }};
            var ruta = "{{ URL::to('/admin/entradas/detalle/tabla') }}/" + id;
    ...
    <script>
        ...
        function infoEditar(id){
            ...
            axios.post(url+'/entradas/historial/deta/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/entradas/historial/deta/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
