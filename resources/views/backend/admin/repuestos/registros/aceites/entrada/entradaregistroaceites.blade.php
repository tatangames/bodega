...
<div id="divcontenedor" style="display: none">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h2>Registro de Entradas para Aceites y Lubricantes</h2>
            </div>
        </div>
    </section>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group" style="float: right">
                                ...
                                <button type="button" onclick="abrirModal()" class="btn btn-primary btn-sm float-right" style="margin-top:10px; margin-right: 15px;">
                                    <i class="fas fa-plus" title="Agregar Repuesto"></i> Agregar Entrada</button>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="formulario-repuesto">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label class="control-label">Aceite o Lubricante</label>

                                <table class="table" id="matriz-busqueda" data-toggle="table">
                                    <tbody>
                                    <tr>
                                        <td>
                                            <input id="repuesto" autocomplete="off" placeholder="Se busca por VISCOSIDAD" data-info='0' class='form-control' style='width:100%' onkeyup='buscarMaterial(this)' maxlength='400'  type='text'>
                            ...
                            <div class="form-group" >
                                <label class="control-label">Ubicación de Bodega</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-md-6">
                                    <input id="cantidad" autocomplete="off" class='form-control' type='number' placeholder="0">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input class='form-control' autocomplete="off" id="precio" type='number' placeholder="0.00">
                                </div>
                            </div>
    ...
    <script>
        ...
        function guardarEntrada(){
            ...
            for(var f = 0; f < precio.length; f++){
                ...
                if (datoPrecio > 9000000) {
                    colorRojoTabla(f);
                    toastr.error('Fila #' + (f + 1) + ' Precio máximo 9 millones');
                    return;
                }
            }
            ...
            axios.post(url+'/aceiteylubricantes/entrada/guardar', formData, {
            })
                .then((response) => {
                    closeLoading();
