...
<div id="divcontenedor" style="display: none">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h2>Registro de Entradas para Llantas</h2>
            </div>
        </div>
    </section>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="radio" id="check-nuevo"
                                               name="contact" value="Llanta Nueva" style="transform: scale(1.3);">
                                        <label for="contactChoice1"> Llanta Nueva</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="radio" id="check-inventario"
                                               name="contact" value="Llanta de Inventario" style="transform: scale(1.3);">
                                        <label for="contactChoice2"> Llanta de Inventario</label>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Agregar Llantas</h4>
                ...
                <div class="modal-body">
                    ...
                    <form id="formulario-repuesto">
                        <div class="card-body">
                            ...
                            <div class="form-group" >
                                <label class="control-label">Seleccionar Ubicación Bodega</label>
                                <div class="col-md-6">
                                    <select id="select-bodega" class="form-control">
...
@section('archivos-js')
    ...
    <script>
        ...
        function abrirModal(){
            ...
            $('#select-bodega').prop('selectedIndex', 0).change();
        ...
        function agregarFila(){
            ...
            var equipoNombre = $( "#select-bodega option:selected" ).text();
            ...
            if(bodega === ''){
                toastr.error('Ubicación bodega es requerido');
                return;
            }
            ...
            var markup = "<tr>" +
                ...
                "<td>" +
                "<input name='ubicacionArray[]' disabled data-info='" + bodega + "' value='" + equipoNombre + "' class='form-control' type='text'>" +
                "</td>" +
        ...
        function guardarEntrada(){
            ...
            var equipoNom = $("input[name='ubicacionArray[]']").map(function(){return $(this).val();}).get();
            var bodega = $("input[name='ubicacionArray[]']").map(function(){return $(this).attr("data-info");}).get();
            ...
            for(var z = 0; z < equipoNom.length; z++){
                ...
                let detalle = bodega[z];

                // identifica si el 0 es tipo number o texto
                if(detalle == 0){
                    colorRojoTabla(z);
                    alertaMensaje('info', 'No encontrado', 'En la Fila #' + (z+1) + " Ubicación bodega no encontrado, Borrar fila y agregar de nuevo.");
                    return;
                }

                if(datoDescripcion === ''){
                    colorRojoTabla(z);
                    toastr.error('Fila #' + (z+1) + ' ubicación bodega es requerido');
                    return;
                }
            }
            ...
            for(var p = 0; p < cantidad.length; p++){
                ...
                formData.append('bodega[]', bodega[p]);
